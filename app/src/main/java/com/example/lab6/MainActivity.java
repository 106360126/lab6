...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Data[] trandData = new Data[transNameArray.length];
        for(int i=0;i<trandData.length;i++)
        {
            trandData[i] = new Data();
            trandData[i].name = transNameArray[i];
            trandData[i].photo = transPhotoIdArray[i];
        }

        MyAdpter transAdapter  = new MyAdpter(trandData,R.layout.trans_list);
        ...
        MyAdpter cubeeAdapter = new MyAdpter(cubeeData,R.layout.cubee_list);
    ...
    public class MyAdpter extends BaseAdapter{
        ...
        public  MyAdpter(MainActivity.Data[] data,int view){
            this.data = data;
            this.view = view;
        }
        @Override
